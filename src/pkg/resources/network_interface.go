...
func NewNIC(stack cdktf.TerraformStack, config apps.Config, naming *naming.Naming, rg *resourcegroup.ResourceGroup, subnet *vnet.VirtualNetworkSubnetOutputReference, ip *publicip.PublicIp) *nic.NetworkInterface {
...
func NewNICAssocASG(stack cdktf.TerraformStack, config apps.Config, nic *nic.NetworkInterface, asg *asg.ApplicationSecurityGroup) *nicasg.NetworkInterfaceApplicationSecurityGroupAssociation {
...
func NewNICAssocNSG(stack cdktf.TerraformStack, config apps.Config, nic *nic.NetworkInterface, nsg *nsg.NetworkSecurityGroup) *nicnsg.NetworkInterfaceSecurityGroupAssociation {
